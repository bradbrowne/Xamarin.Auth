...
namespace Xamarin.Auth
{
	...
	internal class XamarinWebAuthenticatorActivity : Activity
#else
	public class XamarinWebAuthenticatorActivity : Activity
#endif
	{
		WebView webView;
		...
		{
			XamarinWebAuthenticatorActivity activity;
			HashSet<SslCertificate> sslContinue;
			Dictionary<SslCertificate, List<SslErrorHandler>> inProgress;

			public Client (XamarinWebAuthenticatorActivity activity)
			{
