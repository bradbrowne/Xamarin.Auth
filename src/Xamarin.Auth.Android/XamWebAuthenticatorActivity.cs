...
namespace Xamarin.Auth
{
	...
	internal class XamWebAuthenticatorActivity : Activity
#else
	public class XamWebAuthenticatorActivity : Activity
#endif
	{
		WebView webView;
